        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PagePermissions_UserOrRole", "(UserId IS NOT NULL AND RoleId IS NULL) OR (UserId IS NULL AND RoleId IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcements_IsPublished_DeletedAt",
                table: "Announcements",
                columns: new[] { "IsPublished", "DeletedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentBlocks_PageId_DeletedAt",
                table: "ContentBlocks",
                columns: new[] { "PageId", "DeletedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_MenuGroup_DeletedAt",
                table: "MenuItems",
                columns: new[] { "MenuGroup", "DeletedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_News_IsPublished_DeletedAt",
                table: "News",
                columns: new[] { "IsPublished", "DeletedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PagePermissions_PageId_UserId_RoleId",
                table: "PagePermissions",
                columns: new[] { "PageId", "UserId", "RoleId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pages_IsPublished_DeletedAt",
                table: "Pages",
                columns: new[] { "IsPublished", "DeletedAt" });
